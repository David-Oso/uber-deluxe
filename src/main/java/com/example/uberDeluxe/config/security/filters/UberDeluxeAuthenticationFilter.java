...
public class UberDeluxeAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)throws AuthenticationException{
        ...
        //TODO: Create an authentication object that contains authentication credentials,
        ...
        try{
            ...
            //TODO: 4. Store authenticated object in the security context
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException{
        ...
        String accessToken = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.ES512, jwtUtil.getJwtSecret())
                .compact();

    String refreshToken = Jwts.builder()
            .setIssuer("uber-deluxe")
            .setExpiration(Date.from(Instant.now()
