...
import com.example.uberDeluxe.service.PassengerService;
...
public class PassengerController {
    ...
    @PostMapping
    public ResponseEntity<?> register(@Valid @ModelAttribute RegisterPassengerRequest registerPassengerRequest){
